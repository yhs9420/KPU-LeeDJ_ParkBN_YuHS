...
import org.tensorflow.demo.fragment.LegacyCameraConnectionFragment;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    private ArrayList captureIngredientList = new ArrayList();
    private List<String> captureIngredientNameList = new ArrayList<>();
    private List<String> items = new ArrayList<>();

    public static String captureIngredientName;
