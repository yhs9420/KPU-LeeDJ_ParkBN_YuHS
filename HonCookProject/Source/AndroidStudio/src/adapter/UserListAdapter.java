...
import org.tensorflow.demo.request.DeleteRequest;
...
public class UserListAdapter extends BaseAdapter {
    ...
    public UserListAdapter(Context context, Activity activity, List<User> userList, Activity parentActivity, List<User> saveList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setMessage("이 회원을 정말 삭제하시겠습니까?")
                        .setCancelable(false)
