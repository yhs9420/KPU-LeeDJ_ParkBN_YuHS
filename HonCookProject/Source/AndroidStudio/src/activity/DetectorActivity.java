...
import org.tensorflow.demo.activity.CameraActivity;
...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static final float MINIMUM_CONFIDENCE_YOLO = 0.01f;
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        final Intent intent = new Intent(DetectorActivity.this, CaptureListActivity.class);
                        ...
                        for (final Classifier.Recognition result : results) {
                            ...
                            if (location != null && result.getConfidence() >= minimumConfidence && !result.getTitle().equals("???")) {
                                ...
                                productName.add(result.getTitle());
                            }
                            count++;
                        ...
                        btnDetectObject.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if (!productName.isEmpty()) {
                                    ...
                                    final String user_name = intent2.getStringExtra("userName");
                                    intent.putExtra("captureIngredient", productName);
                                    intent.putExtra("userName", user_name);
                                    startActivity(intent);
                                }
                                if (productName.isEmpty()) {
                                    Toast.makeText(getApplicationContext(), "캡처된 식재료가 없음", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            ...
            /*btnDetectObject.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View view) {
                  if(productName!=null) {
                    intent.putExtra("captureIngredient", productName);
                    startActivity(intent);
                    //Toast.makeText(getApplicationContext(), "식재료 캡처 완료", Toast.LENGTH_SHORT).show();
                  }
                if(productName==null) {
                  Toast.makeText(getApplicationContext(), "캡처된 식재료가 없음", Toast.LENGTH_SHORT).show();
                }
